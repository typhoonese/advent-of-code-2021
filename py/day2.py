...
filePath = '../data/movement.txt'
submarineMovementFile = open(filePath, 'r')
submarineMovements = submarineMovementFile.readlines()
...
print("[Puzzle 1] Horizontal position: ", horizontalPosition)
print("[Puzzle 1] Depth position: ", depthPosition)
print("[Puzzle 1] Result: ", horizontalPosition * depthPosition)
...
print("\n[Puzzle 2] Horizontal position: ", horizontalPosition)
print("[Puzzle 2] Depth position: ", depthPosition)
print("[Puzzle 2] Result: ", horizontalPosition * depthPosition)
